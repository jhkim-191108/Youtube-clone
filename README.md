...
| 포지션 | 이름 | 담당 역할 (예시) | 
| :---: | :---: | :--- | 
| **👑 Team Leader** | **정다혜** | `video` 프로젝트 진척 상황 관리, Git, 회의록 정리, Video 페이지 작업 |
| **🧑‍💻 Member** | **김내현** | `channel` 회의록 정리, Channel 페이지 작업 | 
| **🧑‍💻 Member** | **김지훈** | `main_header` 회의록 정리, Home 페이지 작업, Header 작업, SideMenu 작업 |


---
*This project is created by First Class.*
